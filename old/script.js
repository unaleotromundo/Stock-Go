    ...
    if (Object.keys(stock).length === 0) {
        container.innerHTML = `
            <div class="stock-card">
                ...
                <p>Comienza agregando productos en la sección "Cargar Stock" o carga los datos de ejemplo.</p>
...
// === Confirmar limpieza total con advertencia clara ===
...
// === Exportar JSON + PDF en un solo clic ===
function exportDataAndPDF() {
    ...
    jsonLink.click();
    // 2. Generar PDF en nueva ventana
    setTimeout(() => {
...
// === Funciones para el modal de Cargar Stock ===
